...
- React query là gì? setup dev tool, gọi query
...
React Query có cơ chế caching hơi khác một chút so với RTK Query, nên đừng lấy logic của RTK Query rồi suy ngược lại React Query cũng giống vậy nhé.
