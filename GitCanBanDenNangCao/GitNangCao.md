...
### Sự khác nhau giữa `git reset`, `git restore`, `git revert` ( NOTE 2 )
...
## Khi nào Git sẽ bắt chúng ta pull code về trước khi push lên ( NOTE 3 )
...
### Nhưng nguyên tắc để dùng Git an toàn ( NOTE 4 )
